...
export default function results(props) {
    return (
        <div className='results-info'>
            ...
            <h2>Try these activities: {getSports(Number(props.history.location.state.age), Number(props.history.location.state.weight),(props.history.location.state.goal)).join(', ')}</h2>
